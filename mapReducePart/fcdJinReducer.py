    ...
    for carID, group in groupby(data, itemgetter(0)):
        try:
            ...
            for carID, label in group:
                if (label.split(',')[2] != 'None'):
                    temlist = []
                    temlist.append(label.split(',')[0])
                    temlist.append(label.split(',')[1])
                    temlist.append(label.split(',')[2])
                    temlist.append(label.split(',')[3])
            ...
            for item in labelList:
                ...
                roadName = item[2]
                sectionID = item[3]
                print("{},{},{},{},{}".format(carID, latitude, longitude, roadName, sectionID))
